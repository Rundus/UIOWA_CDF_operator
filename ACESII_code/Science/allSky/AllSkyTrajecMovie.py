...
def AllSkyTrajecMovie(wSite, justPrintSiteNames, rocketFolderPath):
    ...
    # --- get All Sky data ---
    inputFiles_allsky = [glob(inputPath_modifier_AllSky + '\\5577\\*.cdf*'), glob(inputPath_modifier_AllSky + '\\6300\\*.cdf*')]
    ...
    for i in range(2):
        ...
        data_dict_attitude['Epoch_esa'][0] = np.array([pycdf.lib.datetime_to_tt2000(data_dict_attitude['Epoch_esa'][0][i]) for i in (range(len(data_dict_attitude['Epoch_esa'][0])))])
    ...
    ###################################
    allGlats = [data_dicts_attitude[0]['GLats'][0], data_dicts_attitude[1]['GLats'][0]]
    allGLongs = [data_dicts_attitude[0]['GLongs'][0], data_dicts_attitude[1]['GLongs'][0]]
    allElevs = [data_dicts_attitude[0]['Elevs'][0], data_dicts_attitude[1]['Elevs'][0]]
    EpochRocket = [data_dicts_attitude[0]['Epoch'][0], data_dicts_attitude[1]['Epoch'][0]]
    geoAlt = [data_dicts_attitude[0]['geoAlt'][0], data_dicts_attitude[1]['geoAlt'][0]]
    geoLat = [data_dicts_attitude[0]['geoLat'][0], data_dicts_attitude[1]['geoLat'][0]]
    geoLong = [data_dicts_attitude[0]['geoLong'][0], data_dicts_attitude[1]['geoLong'][0]]
